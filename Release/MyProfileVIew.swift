...
struct MyProfileVIew: View {
    let avatarLists: [AvatarModel] = [AvatarModel(id: 1, name: "a"),
                                 AvatarModel(id: 2, name: "b"),
                                 AvatarModel(id: 3, name: "c"),
                                 AvatarModel(id: 4, name: "d"),
                                 AvatarModel(id: 5, name: "e"),
                                 AvatarModel(id: 6, name: "f")]
                ...
                HStack {
                    ForEach(avatarLists, id: \.id) { avatar in
                        Button {
                            ...
                            SelectedAvatarView(avatar: avatar.name,
                                               isSelected: avatar.name == avatarImage ? true : false )
                        }
                    }
                }
            }.frame(width: 330)
            Text("Write your name:").frame(width: 300, alignment: .leading)
                .font(.custom("Poppins-SemiBold", size: 17)).fontWeight(.semibold)
